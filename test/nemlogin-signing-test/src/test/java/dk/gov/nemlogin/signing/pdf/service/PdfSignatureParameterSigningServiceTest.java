 ...
 */
class PdfSignatureParameterSigningServiceTest extends AbstractSigningTest {

    private static final Logger LOG = LoggerFactory.getLogger(PdfSignatureParameterSigningServiceTest.class);
