...
public class SPKIDataType {
    ...
    public SPKIDataType withSPKISexpAndAny(Object... values) {
        if (values!= null) {
            for (Object value: values) {
                getSPKISexpAndAny().add(value);
            }
        }
        return this;
    }

    public SPKIDataType withSPKISexpAndAny(Collection<Object> values) {
        if (values!= null) {
            getSPKISexpAndAny().addAll(values);
        }
        return this;
    }
