...
public class X509DataType {
    ...
    public X509DataType withX509IssuerSerialOrX509SKIOrX509SubjectName(Object... values) {
        if (values!= null) {
            for (Object value: values) {
                getX509IssuerSerialOrX509SKIOrX509SubjectName().add(value);
            }
        }
        return this;
    }

    public X509DataType withX509IssuerSerialOrX509SKIOrX509SubjectName(Collection<Object> values) {
        if (values!= null) {
            getX509IssuerSerialOrX509SKIOrX509SubjectName().addAll(values);
        }
        return this;
    }
