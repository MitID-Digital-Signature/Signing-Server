...
public class SignaturePropertiesType {
    ...
    public SignaturePropertiesType withSignatureProperty(SignaturePropertyType... values) {
        if (values!= null) {
            for (SignaturePropertyType value: values) {
                getSignatureProperty().add(value);
            }
        }
        return this;
    }

    public SignaturePropertiesType withSignatureProperty(Collection<SignaturePropertyType> values) {
        if (values!= null) {
            getSignatureProperty().addAll(values);
        }
        return this;
    }

    public SignaturePropertiesType withId(String value) {
        setId(value);
        return this;
    }
